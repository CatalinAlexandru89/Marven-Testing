...
public class MainPage extends PageObject {
    ...
    @FindBy(xpath = "/html/body/section[1]/div/div/div/h1/span")  //-- X-path pentru acel String
    ...
    } //--O functie care imi verifica un string si imi returneaza acelasi string pt a fi verificat.
